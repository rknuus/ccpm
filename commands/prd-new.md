...
### Context Tracking
Run: `${CLAUDE_PLUGIN_ROOT}/scripts/pm/ccpm-context open prd $ARGUMENTS prd-new || true`
...
Save the completed PRD to: `.pm/prds/$ARGUMENTS.md` with this exact structure:
